...
Run the flow for 5-10 seconds and check the file that was created by running the following:
...
![image](/Labs/redLabs/TheIntercepter/binaryoutput.png)
```
...
In the `Access Code` field, paste in the following:
<pre>00011010110011111111110000011101</pre>

<br>
After, match the other fields below:
