...
## Frame sync + Parsing
Let's turn those 0's and 1's into something more readable. We first need to determine where pieces of information, known as **frames**, begin so that we can perform that conversion.<br>
The beginning of **frames** is signified with a **sync word**. For this lab, the **sync word** is **0x1ACFFC1D**, a very common one, which in binary is **00011010110011111111110000011101**
